...
public class Organization implements Serializable {
    ...
    public Organization createUserLogin(String createUserLogin) {
    ...
    public Organization modifyUserLogin(String modifyUserLogin) {
    ...
    public Organization modifyDate(ZonedDateTime modifyDate) {
    ...
    public Organization educationalModules(Set<EducationalModule> educationalModules) {
        this.educationalModules = educationalModules;
        return this;
    }

    public Organization addEducationalModule(EducationalModule educationalModule) {
        this.educationalModules.add(educationalModule);
        educationalModule.setOrganization(this);
        return this;
    }

    public Organization removeEducationalModule(EducationalModule educationalModule) {
        this.educationalModules.remove(educationalModule);
        educationalModule.setOrganization(null);
        return this;
    }
    ...
    public Organization requestEducationalModules(Set<RequestEducationalModule> requestEducationalModules) {
        this.requestEducationalModules = requestEducationalModules;
        return this;
    }

    public Organization addRequestEducationalModule(RequestEducationalModule requestEducationalModule) {
        this.requestEducationalModules.add(requestEducationalModule);
        requestEducationalModule.setOrganization(this);
        return this;
    }

    public Organization removeRequestEducationalModule(RequestEducationalModule requestEducationalModule) {
        this.requestEducationalModules.remove(requestEducationalModule);
        requestEducationalModule.setOrganization(null);
        return this;
    }
