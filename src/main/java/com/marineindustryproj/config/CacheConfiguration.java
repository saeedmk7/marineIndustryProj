package com.marineindustryproj.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("marineindustryproj");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("marineindustryproj");
        ...
        config.getMapConfigs().put("com.marineindustryproj.domain.*", initializeDomainMapConfig(jHipsterProperties));
