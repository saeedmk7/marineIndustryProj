...
/**
 * Criteria class for the Qualification entity. This class is used in QualificationResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /qualifications?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
...
public class QualificationCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final QualificationCriteria that = (QualificationCriteria) o;
        return
