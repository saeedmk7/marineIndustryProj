...
export class RunPhaseMarineSuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.runPhaseService
            ...
            .subscribe(
                (res: HttpResponse<IRunPhaseMarineSuffix[]>) => this.paginateRunPhases(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/run-phase-marine-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInRunPhases() {
        this.eventSubscriber = this.eventManager.subscribe('runPhaseListModification', response => this.loadAll());
    }
    ...
    private paginateRunPhases(data: IRunPhaseMarineSuffix[], headers: HttpHeaders) {
