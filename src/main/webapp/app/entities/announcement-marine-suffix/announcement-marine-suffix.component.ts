...
@Component({
    selector: 'mi-announcement-marine-suffix',
    templateUrl: './announcement-marine-suffix.component.html'
})
export class AnnouncementMarineSuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.announcementService
            ...
            .subscribe(
                (res: HttpResponse<IAnnouncementMarineSuffix[]>) => this.paginateAnnouncements(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/announcement-marine-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IAnnouncementMarineSuffix) {
        return item.id;
    }
    ...
    private paginateAnnouncements(data: IAnnouncementMarineSuffix[], headers: HttpHeaders) {
