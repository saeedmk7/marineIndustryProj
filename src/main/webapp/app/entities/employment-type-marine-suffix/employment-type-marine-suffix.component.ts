...
@Component({
    selector: 'mi-employment-type-marine-suffix',
    templateUrl: './employment-type-marine-suffix.component.html'
})
export class EmploymentTypeMarineSuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.employmentTypeService
            ...
            .subscribe(
                (res: HttpResponse<IEmploymentTypeMarineSuffix[]>) => this.paginateEmploymentTypes(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/employment-type-marine-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IEmploymentTypeMarineSuffix) {
        return item.id;
    }
    ...
    private paginateEmploymentTypes(data: IEmploymentTypeMarineSuffix[], headers: HttpHeaders) {
